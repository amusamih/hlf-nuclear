...
| E5 | Audit traceability | `evaluation/paper-assets/raw/functional-scenarios.csv` and `evaluation/paper-assets/raw/backend-end-to-end-metrics.csv` | `scenario=normal-approval-fuel-shipment`, `audit_events=8`, and `audit_reconstruction_ms avg=4.90` | Case history can be reconstructed quickly from recorded evidence |
